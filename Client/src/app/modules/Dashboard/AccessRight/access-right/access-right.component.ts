...
export class AccessRightComponent implements OnInit, OnChanges {
  ...
  @Output() public SendRoleName: EventEmitter<String> = new EventEmitter();
  @Input() public RoleName: string = '';
  @Input() public lstAccessRight:VMAccessRightForDropDwon[]=[];
  ...
  ngOnChanges(changes: SimpleChanges) {
    ...
    this.IsUpdate = changes.IsUpdate.currentValue;
  }
  ngOnInit() {
    ...
    if (this.IsUpdate) {
      this.database.selectDataChange.subscribe(response => {
